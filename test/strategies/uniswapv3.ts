...
describe("Strategy UniswapV3 Test", function () {
  async function loadFixture() {
    ...
    const poolingManagerMockFactory =
      await ethers.getContractFactory("PoolingManagerMock");
  ...
  it("test setMinReceivedAmountFactor invalid caller", async function () {
    ...
    const uniswapV3StrategyConnected = uniswapV3Strategy.connect(
      impersonatedSigner,
    ) as Contract;
    await expect(
      uniswapV3StrategyConnected.setMinReceivedAmountFactor(
        "980000000000000000",
      ),
  ...
  it("test setMinReceivedAmountFactor invalid slippage", async function () {
    ...
    await expect(
      uniswapV3Strategy.setMinReceivedAmountFactor("1010000000000000000"),
