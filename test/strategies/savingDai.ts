...
describe("Strategy SavingDai Test", function () {
  async function loadFixture() {
    ...
    const erc4626MintableMockFactory =
      await ethers.getContractFactory("ERC4626Mock");
    const yieldToken = await erc4626MintableMockFactory.deploy(
    ...
    const savingDaiStrategy = await upgrades.deployProxy(
      ...
      [poolingManagerAddress, underlyingTokenAddress, yieldTokenAddress],
    );
