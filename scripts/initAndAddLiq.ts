...
async function main() {
    ...
    const positionManager = new ethers.Contract(positionManagerAddress, INonfungiblePositionManagerABI, deployer);
    ...
    const token1Contract = await ethers.getContractAt('WstethMintable', addresses.wsteth);
    ...
    const sqrtPriceX96 = (BigInt(sqrtPrice * 10 ** 18) * BigInt(2) ** BigInt(96)) / BigInt(10 ** 18);
